...
<body>
  ...
  <div class="wrap">
    <div class="logo">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 700"><style type="text/css">
      	.st0{fill:#FFFFFF;}
      	.st1{fill:#6C996C;}
      	.st2{fill:none;}
  ...
  <div class="text">
    <h1>~| error 404 |~</h1>
    <p>Yeah sorry, looks like we don't have what you're looking for here.  Maybe try going back to the <a href='<?php echo $siteRoot; ?>'>start</a>, would be a good way to find your way back on track?</p>
  </div>
  <div class="line"></div>
</div>
