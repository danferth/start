...
//create table FLIERS****************************************************************
echo "<p>creating table <em>table2</em>...</p>";
...
echo "<p>testing to see if <strong>table2</strong> table exists...</p>";
$q = "SHOW TABLES LIKE 'table2'";
$result = $db->query($q);
if(!$result) {
    die(print_r($db->errorInfo(), TRUE));
}
if($result->rowCount()>0)
	{
		echo "<p><strong><em>table2</em> table exists...</strong></p>";
		$result->closeCursor();
	}
//create USERS table***************************************************
